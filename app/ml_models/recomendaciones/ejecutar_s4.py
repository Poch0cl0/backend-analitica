...
from app.ml_models.recomendaciones.config import DIR_REPORTES, DIR_SALIDA, RECOMENDACIONES
from app.ml_models.recomendaciones.datos import cargar_dataset_entrenamiento
...
## Archivos
- app/ml_models/models/recomendaciones_cart.pkl
- app/ml_models/models/recomendaciones_random_forest.pkl
- app/ml_models/recomendaciones/predecir_s4.py
""",
        encoding="utf-8",
    )
