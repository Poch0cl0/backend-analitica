"""Carga datos S-3 y probabilidad del modelo S-2 (regresión logística)."""
...
def features_s3_desde_paciente(paciente: dict) -> pd.DataFrame:
    """Construye la fila de 6 variables S-3 a partir de datos clínicos de entrada."""
    ...
    return out[FEATURES_S3]


def cargar_datos_s3() -> pd.DataFrame:
...
features_s4_desde_paciente = features_s3_desde_paciente
cargar_datos_s4 = cargar_datos_s3
